var data = [
    ...
    { label: 'Aromantic', explanation: "A person who lacks romantic attraction or interest in romantic expression. An aromantic person's sexual and romantic orientations may differ (e.g. aromantic lesbian), and they may have romantic and/or sexual partners."},
    { label: 'Asexual', explanation: "A person who lacks sexual attraction or interest in sexual expression. An asexual person's sexual and romantic orientations may differ (e.g. biromantic asexual), and they may have sexual and/or romantic partners."},
    { label: 'ARIA', value: 'Accessible Rich Internet Applications', explanation:"is a set of attributes that define ways to make web content and web applications more accessible to people with disabilities.", link:"https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA"},
    { label: 'ASL', value: 'American Sign Language'},
    ...
    { label: 'Biphobia', explanation: "The fear, hatred, or aversion of people who are attracted to more than one gender."},
    { label: 'Bisexual/Biromantic', explanation: "A person who is sexually and/or romantically attracted to two or more genders."},
    ...
    { label: 'CAP', value: 'Cloud Access Point'},
    ...
    { label: 'CIRT', value: 'Computer Incident Response Team'},
    { label: 'CIS', value: 'Centre for Internet Security'},
    { label: 'Cisgender', explanation: "A person who identifies with the gender they were assigned at birth."},
    ...
    { label: 'Gay', explanation: "A person who is sexually and/or romantically attracted to people of their same sex or gender identity. Traditionally this identity was reserved for men, but it has been adopted by people of all gender identities."},
    ...
    { label: 'GEDS', value: 'Government Electronic Directory Services', explanation: "The Government Electronic Directory Services (GEDS) provides a directory of public servants across Canada. Information in this directory is supplied by individual federal government departments and agencies and updated by one or more data administrators within each department.", link:"https://geds-sage.gc.ca/en/GEDS/"},
    { label: 'Gender Dysphoria', explanation: "A medical diagnosis often required by health providers and/or health insurance plans before prescriptions for hormones or gender affirming surgeries will be provided. It can be understood as discomfort or distress experienced by a person who feels their sense of their gender identity differs from their body, based on societal expectations."},
    { label: 'Gender Expression', explanation: "Gender expression refers to the various ways in which people choose to express their gender identity. For example: clothes, voice, hair, make-up, etc. A person's gender expression may not align with societal expectations of gender. It is therefore not a reliable indicator of a person's gender identity."},
    { label: 'Gender Identity', explanation: "Internal and deeply felt sense of being a man or woman, both or neither A persons gender identity may or may not align with the gender typically associated with their sex. It may change over the course of one\' lifetime."},
    { label: 'Gender-fluid', explanation: "A person whose gender identity varies over time and may include male, female and non-binary gender identities."},
    ...
    { label: 'Heterosexual/Heteroromantic', explanation: "A person who is sexually and/or romantically attracted to people of a different gender than themselves."},
    ...
    { label: 'Homophobia', explanation: "The fear, hatred, or aversion of people who experience same-sex attraction."},
    { label: 'Homosexual', explanation: "(*no longer commonly used in English) This term is no longer in common use. See \"gay\" and \"lesbian\". The term homosexual has fallen out of favour as it is associated with the historic medical understanding of same-sex attraction as a mental illness. However, equivalents of \"homosexual\" are commonly used in French and other languages."},
    ...
    { label: 'IAAS', value: 'Infrastructure as a Service'},
    ...
    { label: 'ISL', value: 'Indigenous sign languages'},
    { label: 'ISSIP', value: 'Information System Security Implementation Process'},
    { label: 'ITO', value: 'Industrial Technologies Office'},
    { label: 'ITSG', value: 'Information Technology Security Guidance'},
    ...
    { label: 'Lesbian', explanation: 'Typically a woman who is sexually and/or romantically attracted to other women.'},
    { label: 'LGBTI', value: "Lesbian, Gay, Bisexual, Transgender, Intersex. This is the internationally recognized acronym."},
    { label: 'LGBTQ2', value: "Lesbian, Gay, Bisexual, Transgender, Queer, Two-Spirit. This is the acronym used by the Government of Canada to refer to the Canadian community."},
    { label: 'LSQ', value: 'Langue des signes québécoise'},
    ...
    { label: 'Micromission', value: '3-6 months work assignment. A micromissionee usually comes from another GC department (ie secondment)'},
    ...
    { label: 'NIST', value: 'National Institute of Standards and Technology'},
    { label: 'Non-Binary', explanation: "(also \"genderqueer\"). Referring to a person whose gender identity does not align with a binary understanding of gender such as man or woman. It is a gender identity which may include man and woman, androgynous, fluid, multiple, no gender, or a different gender outside of the \"woman-man\" spectrum."},
    ...
    { label: 'Pansexual', explanation: "A person whose choice of sexual or romantic partner is not limited by the other person's sex, gender identity or gender expression."},
    ...
    { label: 'PIA', value: 'privacy impact assessments'},
    ...
    { label: 'POAM', value: 'Plan of Actions and Milestones'},
    ...
    { label: 'Questioning', explanation: "A person who is uncertain about their sexual orientation and/or gender identity; this can be a transitory or a lasting identity."},
    ...
    { label: 'SCED', value: 'Secure Cloud Enablement and Defence', explanation:"Required for IaaS or if you need to have a direct connection between on-prem data centres and the cloud.", link:"https://www.canada.ca/en/shared-services/corporate/publications/2019-20-departmental-plan/supplementary-tables/status-report-secure-cloud-enablement-defence.html"},
    ...
    { label: 'Sexual Orientation', explanation: "Romantic and sexual attraction for people of the same or another sex or gender."},
    ...
    { label: 'SGM', value: "Sexual and Gender Minorities"},
    { label: 'SIEM', value: 'Security Information and Event Management', explanation: "Security information and event management is a subsection within the field of computer security, where software products and services combine security information management and security event management. They provide real-time analysis of security alerts generated by applications and network hardware."},
    ...
    { label: 'SOGI', value: "Sexual Orientation and Gender Identity"},
    { label: 'SOGIE', value: "Sexual Orientation and Gender Identity and Expression"},
    { label: 'SOGIESC', value: "Sexual Orientation and Gender Identity and Expression and Sex Characteristics"},
    ...
    { label: 'SSOGIE', value: "(* This is the acronym used by the Women and Gender Equality (WAGE)) Sex, Sexual Orientation and Gender Identity and Expression. This is the acronym used by WAGE."},
    ...
    { label: 'TRA', value: 'Threat and risk assessment', explanation:"A process of identifying system assets and how these assets can be compromised, assessing the level of risk that threats pose to assets, and recommending security measures to mitigate threats.", link:"https://www.cyber.gc.ca/en/threat-and-risk-assessment"},
    { label: 'Transgender', explanation: "(also trans). A person whose gender identity differs from what is typically associated with the sex they were assigned at birth."},
    { label: 'Transphobia', explanation: "The fear, hatred, or aversion of people whose gender identities differ from the sex they were assigned at birth."},
